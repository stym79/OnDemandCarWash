...
public class CustomerController {
	...
	@Autowired
	private CustomerRepository customerServiceRepository;
	...
	public Optional<Customer> getCustomerById(@PathVariable int id) throws ApiRequestException {
		return Optional.of(customerServiceRepository.findById(id)
	...
	public ResponseEntity<Object> updateCustomer(@PathVariable int id, @RequestBody Customer customer) {
		boolean isCustomerExist = customerServiceRepository.existsById(id);
		if (isCustomerExist) {
